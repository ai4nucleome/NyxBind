...
def train():
    ...
    trainer = transformers.Trainer(model=model,
                                   ...
                                   callbacks=[EarlyStoppingCallback(early_stopping_patience=10)])  # Add early stopping callback directly here
    trainer.train()


    adapter_name = os.path.basename(os.path.normpath(data_args.data_path))
    adapter_save_dir = os.path.join(training_args.output_dir, "adapters", adapter_name)
